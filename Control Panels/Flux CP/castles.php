<?php
	...
	while( $data = $mysql->fetcharray($mydata) )
	{
		...
		{ // Post Image
			...
			<font size="2" color="#4169E1"><b>~ ' . $castles[$data['castle_id']] . ' ~<b></font><br><br></center>';
			$castle_id = $data['castle_id'];
		}

		echo '
			<table witdh="580" border="1" cellpadding="0" cellspacing="0" bordercolor="#4169E1">
				<tr>
					<td>
						<table width="580" border="0" cellpadding="0" cellspacing="0" bgcolor="#800080">
							...
							<tr>
								<td>
									<font color="#FFFF00"><b>' . htmlformat($data['master']) . '</b></font>
								</td>
								<td align="right">
									<font color="#FFFF00"><b>' . calc_posesion_time($data['posesion_time']) . '</b>&nbsp;</font>
								</td>
							</tr>
						</table>
					</td>
