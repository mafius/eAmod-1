<?php
	...
	opentable('Ranking de Rompe Emperiums');
?>
	<table width="600">
		<tr>
			...
			<td align="center" class="head" width="100">Empes</td>
...
<?php
	...
	if ($who)
	{
		...
		while ($char = $mysql->fetcharray($who))
		{
			...
			echo '
					...
					<td align="center"><img src="./images/item/small/714.png"> x ' . $char['value'] .'</td>
					<td align="center">
						' . $char['last_map'] . '<br>
	...
	echo '
			<tr>
				<td align="center" colspan="8">Total en Lista : <b>' . $total . '</b> Emperiums : <b>' . $empes . '</b></td>
			</tr>
		</table>
	';
