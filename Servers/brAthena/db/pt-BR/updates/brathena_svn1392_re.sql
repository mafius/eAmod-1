...
-- Experiência & Drop Rate
-- Type,Race,Level difference,Rate
-- TYPE:
--  1=Experiência, 2= Item drop
-- RACE:
--   0=Formless, 1=Undead, 2=Brute, 3=Plant, 4=Insect,
--   5=Fish, 6=Demon, 7=Demi-Human, 8=Angel, 9=Dragon, 
--   10=Boss monsters, 11=Normal monsters
-- Nota: RENEWAL_DROP ou RENEWAL_EXP deve ser habilitado.

-- Modificadores de EXP devido à diferença de nível habilitado.
...
-- Modificadores de taxa de queda devido à diferença de nível
