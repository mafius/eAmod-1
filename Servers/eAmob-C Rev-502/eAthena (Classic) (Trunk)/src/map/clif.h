...
void clif_skill_select_request( struct map_session_data *sd ); //self
void clif_skill_itemlistwindow( struct map_session_data *sd, int skill_id, int skill_lv ); //self
