...
struct map_session_data {
	...
	unsigned char change_level_2; // Now that 3rd jobs exist, we need to remember 2nd job levels. [Rytech]
...
enum equip_pos {
	...
	// 3ceam2 desactiva esta funcionalidad agregada en eamod::iSaaC
...
#define pc_iswarg(sd)         ( (sd)->sc.option&OPTION_WUG ) //eamod
